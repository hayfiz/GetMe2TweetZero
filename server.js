...
.then(function (userActivity) {
    ...
    .on ('direct_message', (data) => console.log (data + ' - direct_message'))
    .on ('direct_message_indicate_typing', (data) => console.log (data + ' - direct_message_indicate_typing'))
    .on ('direct_message_mark_read', (data) => console.log (data + ' - direct_message_mark_read'))
